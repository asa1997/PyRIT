...
# if [ -n "$1" ]; then
	...
	sudo docker exec -e PROMPTINTEL_API_KEY="$PROMPTINTEL_API_KEY" -w /app/fintech_ai_audit pyrit-jupyter python main_audit.py --threats prompt_injection --max-prompts 5 --batch-score
# else
